...
{
    public partial class ConsumidorFinalFaccccc : Form
    {
        public ConsumidorFinalFaccccc()
        {
            InitializeComponent();
        }
        ...
        {
            Generadorfecha ff = new Generadorfecha();
            ff.ShowDialog();
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    //generame el ret
                    conexion.Open();
                    SqlCommand lopo = new SqlCommand("INSERT INTO ConsumidorFi values('" + txtrets.Text + "')", conexion);
                    lopo.ExecuteNonQuery();
                    conexion.Close();

                    MasConsimiFi lp = new MasConsimiFi();
                    ...
                    //continua ccon la factura
                }
                catch (Exception pp)
                {
                    MessageBox.Show("Algo va Mal" + pp);
                }
                ...
                if (con_filas != 0)
                {
                    ...
                    try
                    {
                        ...
                        foreach (DataGridViewRow Fila in dgv.Rows)
                        {
                            ...
                            SqlCommand comand = new SqlCommand("INSERT INTO Registros VALUES ('" + fechaa.ToString() + "', '" + txtrets.Text + "', '" + Fila.Cells[0].Value.ToString() + "', '" + Fila.Cells[3].Value.ToString() + "', '" + LOTEee.ToString() + "', '" + Fila.Cells[2].Value.ToString() + "' ,'" + Fila.Cells[1].Value.ToString() + "', '" + lblpreventa.Text + "', '" + Ganancia0.ToString("N2", new CultureInfo("en-US")) + "', '" + Fila.Cells[4].Value.ToString() + "', '" + Fila.Cells[5].Value.ToString() + "', '" + Ganancia.ToString("N2", new CultureInfo("en-US")) + "' )", conexion);
                        ...
                        ReporteFiscal rp = new ReporteFiscal();
        ...
        {
            txtfe.Text = DateTime.Now.ToLongDateString();
            fechaa = DateTime.Now.ToShortDateString();
        }

        private void ConsumidorFinalFaccccc_Load(object sender, EventArgs e)
        {
        ...
        private void ConsumidorFinalFaccccc_Enter(object sender, EventArgs e)
        {

        }

        private void txtprecioo_MouseEnter(object sender, EventArgs e)
        {
        ...
        private void ConsumidorFinalFaccccc_KeyPress(object sender, KeyPressEventArgs e)
        {
