...
{
    public partial class CreFiscal : Form
    {
        public CreFiscal()
        {
            InitializeComponent();
        ...
        private void lol(object sender, MouseEventArgs e)
        {
            txtcodigofac.Text = "";
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    //generame el ret
                    conexion.Open();
                    SqlCommand lopo = new SqlCommand("INSERT INTO CreditoFi values('" + txtrets.Text + "')", conexion);
                    lopo.ExecuteNonQuery();
                    conexion.Close();

                    MaxxCreditoFiscal lp = new MaxxCreditoFiscal();
                    ...
                    if (lp.DialogResult == DialogResult.OK)
                    {
                        ...
                        txtrets.Text = lp.data.Rows[lp.data.CurrentRow.Index].Cells[0].Value.ToString();
                ...
                {
                    MessageBox.Show("Algo va Mal..." + lp);
                }
                ...
                if (con_filas != 0)
                {
                    ...
                    try
                    {
                        ...
                        foreach (DataGridViewRow Fila in dgv.Rows)
                        {
                            ...
                            SqlCommand comand = new SqlCommand("INSERT INTO Registros VALUES ('" + fechaaa.ToString() + "', '" + txtrets.Text + "', '" + Fila.Cells[0].Value.ToString() + "', '" + Fila.Cells[3].Value.ToString() + "', '" + LOTEee.ToString() + "', '" + Fila.Cells[2].Value.ToString() + "' ,'" + Fila.Cells[1].Value.ToString() + "', '" + lblpreventa.Text + "', '" + Ganancia0.ToString("N2", new CultureInfo("en-US")) + "', '" + Fila.Cells[4].Value.ToString() + "', '" + Fila.Cells[5].Value.ToString() + "', '" + Ganancia.ToString("N2", new CultureInfo("en-US")) + "' )", conexion);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            fechaaa = DateTime.Now.ToShortDateString();
        ...
        private void CreFiscal_Load(object sender, EventArgs e)
        {
        ...
        private void CreFiscal_KeyPress(object sender, KeyPressEventArgs e)
        {
