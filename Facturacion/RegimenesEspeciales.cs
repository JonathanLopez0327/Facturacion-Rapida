...
{
    public partial class RegimenesEspeciales : Form
    {
        public RegimenesEspeciales()
        {
            InitializeComponent();
        }
            ...
            else
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        //convercion;
                        txttotalll.Text = "RD$: " + ttal.ToString("N2", new CultureInfo("en-US"));
        ...
        private void RegimenesEspeciales_Load(object sender, EventArgs e)
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            fechaa4 = DateTime.Now.ToShortDateString();
        }
        ...
        private void RegimenesEspeciales_KeyPress(object sender, KeyPressEventArgs e)
        {
