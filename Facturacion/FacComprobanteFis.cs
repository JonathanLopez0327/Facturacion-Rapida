...
{
    public partial class FacComprobanteFis : Form
    {
        public FacComprobanteFis()
        {
            InitializeComponent();
        }
        ...
        private void dop(object sender, MouseEventArgs e)
        {
            txtdes.Text = "";
        }

        private void vv(object sender, MouseEventArgs e)
        {
            txtprecioo.Text = "";
        }

        private void FacComprobanteFis_Load(object sender, EventArgs e)
        {
        ...
        {
            Generadorfecha fef = new Generadorfecha();
            fef.ShowDialog();
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            fechaa2 = DateTime.Now.ToShortDateString();
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (con_filas > 0)
            {
                try
                {
                    ...
                    txtsubt.Text = ttal.ToString();

                    int to;
                    to = Convert.ToInt32(txtsubt.Text);
                    ITB = to * 0.18;
                    txtitbiss.Text = ITB.ToString();


                    PREF = ttal - ITB;
                    txttotalll.Text = "RD$" + PREF.ToString();
                ...
                {
                    MessageBox.Show("Algo Va Mal..." + mm);
                }
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (cli.DialogResult == DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Algo Va Mal..." + er);
                }
        ...
        private void FacComprobanteFis_KeyPress(object sender, KeyPressEventArgs e)
        {
